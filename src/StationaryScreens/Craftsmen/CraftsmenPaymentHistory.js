...
function CraftsmenPaymentHistory() {
    return (
        <View style={{
            flex: 1,
            paddingLeft: 20,
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', padding: 10, borderRadius: 8, marginTop: 20, borderWidth: 1, borderColor: "#999999" }}>
                <view style={{
                    ...
                    <Image
                        source={require('../../../assets/images/Craftsmen.jpg')}
                        style={{
                            height: 50,
                            width: 50,
                            borderRadius: 50 / 2,
                    ...
                    <view>
                        <View style={{
                            ...
                            <Text style={{ fontWeight: 700, fontFamily: 'sans-serif', fontSize: 15 }}>Craftsman Name</Text>
                ...
                <view>
                    ...
                    <view>
                        <View style={{
                            ...
                            <Text style={{ marginTop: 10, fontSize: 12, fontWeight: 600, }}>Calligraphy</Text>
...
export default CraftsmenPaymentHistory;